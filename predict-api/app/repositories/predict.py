...
async def predict_text(text_content: str, model_type: str, response=Response) -> Union[str, float]:
    ...
    if model_type == 'naive_bayes':
        ...
        modelo_soja.load_state_dict(torch.load("models/modelo_redeneural_bert_soja.pt", map_location=torch.device('cpu')))
        ...
        return predict_content(text_content= text_content, model_type= model_type, final_sentiment=final_sentiment, negative=probs[0]*100, positive=probs[1]*100, neutral=probs[2]*100)